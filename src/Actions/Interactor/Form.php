...
class Form extends Interactor
{
    ...
    public function email($column, $label = '')
    {
        ...
        $this->addField($field)->setView('multi::actions.form.text');
    ...
    public function image($column, $label = '')
    {
        ...
        $this->addField($field)->setView('multi::actions.form.file');
    ...
    public function multipleImage($column, $label = '')
    {
        ...
        $this->addField($field)->setView('multi::actions.form.muitplefile');
    ...
    protected function resolveView($class)
    {
        ...
        return "multi::actions.form.{$name}";
    }
    ...
    public function addModalHtml()
    {
        ...
        $modal = view('multi::actions.form.modal', $data)->render();
