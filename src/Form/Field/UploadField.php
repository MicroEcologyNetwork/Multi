...
trait UploadField
{
    ...
    {
        $this->disk(config('multi.upload.disk'));
    }
    ...
    protected function setupDefaultOptions()
    {
        $defaults = [
            ...
            'msgPlaceholder'       => trans('multi.choose_file'),
            'browseLabel'          => trans('multi.browse'),
            'cancelLabel'          => trans('multi.cancel'),
            'showRemove'           => false,
            'showUpload'           => false,
            'showCancel'           => false,
    ...
    public function objectUrl($path)
    {
        ...
        return Storage::disk(config('multi.upload.disk'))->url($path);
    }
