...
class Listbox extends MultipleSelect
{
    ...
    protected static $css = [
        '/vendor/laravel-multi/bootstrap-duallistbox/dist/bootstrap-duallistbox.min.css',
    ];

    protected static $js = [
        '/vendor/laravel-multi/bootstrap-duallistbox/dist/jquery.bootstrap-duallistbox.min.js',
    ];
...
EOT;
    ...
    public function render()
    {
        $settings = array_merge([
            'infoText'              => trans('multi.listbox.text_total'),
            'infoTextEmpty'         => trans('multi.listbox.text_empty'),
            'infoTextFiltered'      => trans('multi.listbox.filtered'),
            'filterTextClear'       => trans('multi.listbox.filter_clear'),
            'filterPlaceHolder'     => trans('multi.listbox.filter_placeholder'),
