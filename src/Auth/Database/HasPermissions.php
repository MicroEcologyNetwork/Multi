...
trait HasPermissions
{
    ...
    /**
     * Check if user is multiistrator.
     *
     * @return mixed
     */
    public function isMultiistrator(): bool
    {
        return $this->isRole('multiistrator');
    }
    ...
    public function visible(array $roles = []): bool
    {
        ...
        return $this->inRoles($roles) || $this->isMultiistrator();
    }
