...
class MultipleFile extends Field
{
    ...
    protected static $css = [
        '/vendor/laravel-multi/bootstrap-fileinput/css/fileinput.min.css?v=4.5.2',
    ];
     ...
     */
    protected static $js = [
        '/vendor/laravel-multi/bootstrap-fileinput/js/plugins/canvas-to-blob.min.js',
        '/vendor/laravel-multi/bootstrap-fileinput/js/fileinput.min.js?v=4.5.2',
        '/vendor/laravel-multi/bootstrap-fileinput/js/plugins/sortable.min.js?v=4.5.2',
    ];
    ...
    {
        return config('multi.upload.directory.file');
    }
...
EOT;
        ...
        if ($this->fileActionSettings['showRemove']) {
            $text = [
                'title'   => trans('multi.delete_confirm'),
                'confirm' => trans('multi.confirm'),
                'cancel'  => trans('multi.cancel'),
            ];
