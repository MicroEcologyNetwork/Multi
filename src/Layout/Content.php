...
class Content implements Renderable
{
    ...
    {
        return $this->body(Multi::component($view, $data));
    }
    ...
    {
        return $this->row(multi_dump(...func_get_args()));
    }
    ...
    public function render()
    {
        ...
        return view('multi::content', $items)->render();
    }
}
