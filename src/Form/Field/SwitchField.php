...
class SwitchField extends Field
{
    protected static $css = [
        '/vendor/laravel-multi/bootstrap-switch/dist/css/bootstrap3/bootstrap-switch.min.css',
    ];

    protected static $js = [
        '/vendor/laravel-multi/bootstrap-switch/dist/js/bootstrap-switch.min.js',
    ];
