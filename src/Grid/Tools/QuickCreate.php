...
class QuickCreate implements Renderable
{
    ...
    protected function resolveView($class)
    {
        ...
        return "multi::grid.quick-create.{$name}";
    }
    ...
    $('.quick-create .create-form').submit(function (e) {
        ...
        $.ajax({
            ...
            success: function(data, textStatus, jqXHR) {
                ...
                if (data.status == true) {
                    $.multi.toastr.success(data.message, '', {positionClass:"toast-top-center"});
                    $.multi.reload();
                    return;
                }
                
                if (typeof data.validation !== 'undefined') {
                    $.multi.toastr.warning(data.message, '', {positionClass:"toast-top-center"})
                }
            },
            error: function(XMLHttpRequest, textStatus){
                ...
                if (typeof XMLHttpRequest.responseJSON === 'object') {
                    $.multi.toastr.error(XMLHttpRequest.responseJSON.message, '', {positionClass:"toast-top-center", timeOut: 10000});
                }
            }
        });
...
SCRIPT;
    ...
    public function render($columnCount = 0)
    {
        ...
        return view('multi::grid.quick-create.form', $vars)->render();
    }
}
