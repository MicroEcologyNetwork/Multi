...
//            ->seeInElement('a[href="/multi/files"]', 'List')
    ...
    {
        return $this->visit('multi/files/create')
...
//            ->seeInElement('a[href="/multi/files"]', 'List')
    ...
    public function testDeleteFiles()
    {
        ...
        $this->visit('multi/files')
            ->seeInElement('td', 1);

        $files = FileModel::first()->toArray();

        $this->delete('multi/files/1')
