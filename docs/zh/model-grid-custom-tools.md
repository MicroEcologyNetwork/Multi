...
先定义工具类`app/Multi/Extensions/Tools/UserGender.php`：
...
```
视图`multi.tools.gender`文件为`resources/views/multi/tools/gender.blade.php`:
```php
...
先定义操作类`app/Multi/Extensions/Tools/ReleasePost.php`：
```php
<?php
