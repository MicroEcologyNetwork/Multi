...
class Form implements Renderable
{
    ...
    public function destroy($id)
    {
        try {
            ...
            $response = [
                'status'  => true,
                'message' => trans('multi.delete_succeeded'),
            ];
        } catch (\Exception $exception) {
            $response = [
                'status'  => false,
                'message' => $exception->getMessage() ?: trans('multi.delete_failed'),
            ];
        }
    ...
    public function store()
    {
        ...
        if ($response = $this->ajaxResponse(trans('multi.save_succeeded'))) {
            return $response;
        }
    ...
    public function update($id, $data = null)
    {
        ...
        if ($response = $this->ajaxResponse(trans('multi.update_succeeded'))) {
            return $response;
        }
    ...
    protected function redirectAfterSaving($resourcesPath, $key)
    {
        ...
        multi_toastr(trans('multi.save_succeeded'));
    ...
    protected function handleColumnUpdates($id, $data)
    {
        ...
        if ($this->handleOrderable($id, $data)) {
            return response([
                'status'  => true,
                'message' => trans('multi.update_succeeded'),
            ]);
        }
    ...
    public function __call($method, $arguments)
    {
        ...
        multi_error('Error', "Field type [$method] does not exist.");
