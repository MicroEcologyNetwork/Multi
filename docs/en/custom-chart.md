...
`laravel-multi 1.5` has removed all the chart components. If you want to add chart components to the page, you can refer to the following process
...
Create a new view file `resources/views/multi/charts/bar.blade.php`
...
public function index()
{
    return Multi::content(function (Content $content) {
        ...
        $content->body(view('multi.charts.bar'));
    });
}
