        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content" style="border-radius: 5px;">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">{{ multi_trans('multi.choose') }}</h4>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">{{ multi_trans('multi.cancel') }}</button>
                    <button type="button" class="btn btn-primary submit">{{ multi_trans('multi.submit') }}</button>
                </div>
            </div>
        </div>
    </div>
