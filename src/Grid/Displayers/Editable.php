...
class Editable extends AbstractDisplayer
{
    ...
    "success":function(response, newValue){
        if (response.status){
            $.multi.toastr.success(response.message, '', {positionClass:"toast-top-center"});
        } else {
            $.multi.toastr.error(response.message, '', {positionClass:"toast-top-center"});
        }
    }
}
STR;

        Multi::script("$('.$class').editable($options);");
