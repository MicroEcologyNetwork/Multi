...
class Color extends Text
{
    protected static $css = [
        '/vendor/laravel-multi/MultiLTE/plugins/colorpicker/bootstrap-colorpicker.min.css',
    ];

    protected static $js = [
        '/vendor/laravel-multi/MultiLTE/plugins/colorpicker/bootstrap-colorpicker.min.js',
    ];
