...
`MicroEcology\Multi\Form`类用于生成基于数据模型的表单，先来个例子，数据库中有`movies`表
...
$grid = Multi::form(Movie::class, function(Form $form){
...
```php
Multi::form(User::class, function (Form $form) {
