...
```shell
$ composer require laravel-multi-ext/api-tester -vvv
...
```shell
$ php artisan multi:import api-tester
```

Then you can find the entry link in the multi menu, `http://localhost/multi/api-tester`.
