@extends('multi::grid.inline-edit.comm')
...
@section('assert')
    <script>
        @component('multi::grid.inline-edit.partials.popover', compact('trigger'))
            @slot('content')
    ...
    <script>
    @component('multi::grid.inline-edit.partials.submit', compact('resource', 'name'))
