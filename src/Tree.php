...
class Tree implements Renderable
{
    ...
    {
        $trans = [
            'delete_confirm'    => str_replace("'", "\'", trans('multi.delete_confirm')),
            'save_succeeded'    => str_replace("'", "\'", trans('multi.save_succeeded')),
            'refresh_succeeded' => str_replace("'", "\'", trans('multi.refresh_succeeded')),
            'delete_succeeded'  => str_replace("'", "\'", trans('multi.delete_succeeded')),
            'confirm'           => str_replace("'", "\'", trans('multi.confirm')),
            'cancel'            => str_replace("'", "\'", trans('multi.cancel')),
        ];
