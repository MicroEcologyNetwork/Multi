...
class ImageUploadTest extends TestCase
{
    ...
    {
        return $this->visit('multi/images/create')
    ...
    public function testUpdateImage()
    {
        ...
        $this->visit('multi/images/1/edit')
            ->see('ID')
            ->see('Created At')
            ->see('Updated At')
            ->seeElement('input[name=image1]')
    ...
    public function testBatchDelete()
    {
        ...
        $this->delete('multi/images/1,2,3');
    ...
    public function testUploadMultipleImage()
    {
        ...
        $this->visit('multi/multiple-images/create')
        ...
        $this->assertRedirectedTo('/multi/multiple-images');
